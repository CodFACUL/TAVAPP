...
@st.cache
def load_database():
    return pd.read_feather('Avaliacao/database/base.feather'), \
        pd.read_feather('Avaliacao/database/classificacaoz_Customer ID.feather'), \
        pd.read_feather('Avaliacao/database/classificacaoz_Category.feather'), \
        pd.read_feather('Avaliacao/database/classificacaoz_Region.feather'), \
        pd.read_feather('Avaliacao/database/classificacaoz_Segment.feather'), \
        pd.read_feather('Avaliacao/database/clusterizacao_estado.feather'), \
        pd.read_feather('Avaliacao/database/regressao_Region.feather'), \
        pd.read_feather('Avaliacao/database/regressao_Segment.feather'), \
        pd.read_feather('Avaliacao/database/localizacao.feather'), \
        pd.read_feather('Avaliacao/database/estadosUS.feather')
